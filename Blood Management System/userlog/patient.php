    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class=".col-lg-12">
                        <h1 class="page-header" style="text-align: center;"> Select City and Blood Group</h1>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class=".col-lg-12">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        if (isset($_GET['submit'])) {
                                            ...
                                            $qry = "select * from patient where address='$city_info' and bgroup='$blood_group_info'";
						...
						<tr>
						  ...
						  <td>" . $row['address'] . "</td>
                          <td>" . $row['place'] . "</td>
                          <td><button onclick='showalert(this)'>Accept</button></td>
