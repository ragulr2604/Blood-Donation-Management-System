    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href=""><i class="fa fa-heartbeat"></i>Manage Blood Request<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="addblood.php">Add Request</a>
                        </li>
                        <li>
                            <a href="viewblood.php">View Request</a>
                        </li>
                        <li>
                            <a href="editblood.php">Edit Request</a>
                        </li>
                        <li>
                            <a href="deleteblood.php">Remove Request</a>
                        </li>
                    </ul>
                    <!-- /.nav-second-level -->
                </li>
