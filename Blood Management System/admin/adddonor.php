            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                                ...
                                <div class="col-lg-6">
                                    <form role="form" action="added.php" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" placeholder="Enter Address Here" name="place" required>
                                        </div>
			            ...
			            <input class="form-control" id="date" name="date" type="date" value="2019-01-01" required />
                                        </div>
