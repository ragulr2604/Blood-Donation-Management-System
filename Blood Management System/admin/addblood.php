...
<html>
<head>
    <link rel="stylesheet" href="/Blood Management System/reg.css" />
    <!-- Bootstrap Core CSS -->
...
<div id="page-wrapper">
    <div class="container">
        ...
        <form method="post" action="addblood.php" class="reg">
            <div class="formfirst">
                    <div class="fields">
...
if (isset($_POST['name'])) {
    ...
    $qry = "insert into patient(name,gender,bgroup,age,address,number,place) values ('$name','$gender','$bgroup','$age','$address','$number','$place')";
    ...
    if (!$result) {
        ...
        echo " <a href='' div style='text-align: center'><h3>Go Back</h3>";
    }
}
?>
