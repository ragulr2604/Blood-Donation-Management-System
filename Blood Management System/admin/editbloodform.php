...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Request Details</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <div class="row">
                                ...
                                <?php
                                    ...
                                    <form role="form" action="editedblood.php" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="bgroup" value='<?php echo $row['bgroup']; ?>' required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="place" value='<?php echo $row['place']; ?>' required>
                                        </div>

                                        <div class="form-group">
                                            <label>Enter City</label>
                                            <select name="address" id="address" class="form-control demo-default"  value='<?php echo $row['address']; ?>'required>
                                ...
                                <option>Virudhunagar</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="number" name="number" value='<?php echo $row['number']; ?>' required>
                                        </div>
